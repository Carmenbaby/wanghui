...
*/
//-------2018-05-18 start
SWITCH_DECLARE(uint32_t) switch_core_session_poc_hupall_matching_var_ans(_In_ const char *var_name, _In_ const char *var_val, _In_ 
																	 switch_call_cause_t cause, _In_ const char *val_a,_In_ const char *val_b,_In_ const char *val_c,_In_ const char *val_video, switch_hup_type_t type);
#define switch_core_session_poc_hupall_matching_var(_vn, _vv, _c,_va,_vb,_vc,_vvideo) switch_core_session_poc_hupall_matching_var_ans(_vn, _vv, _c,_va,_vb,_vc,_vvideo,SHT_UNANSWERED | SHT_ANSWERED)
//-------2018-05-18 end
