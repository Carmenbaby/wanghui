...
#define CONF_EVENT_MAINT "videoshare::maintenance"
...
typedef struct conference_obj {
	...
	////////////////  2017-7-5  START //////////
	char m_videosharenumber[20]; // 视频被分享的终端号码
	uint32_t last_member_exiting_time; // // 只剩一个成员时，多少秒后自动退出
	switch_time_t videoshare_last_member_time;
	/////////////////   2017-7-5   END    //////
} conference_obj_t;
...
void videoshare_loop_deaf_toggle(conference_member_t *member, caller_control_action_t *action);  // deaf  deaf on
void videoshare_loop_undeaf_toggle(conference_member_t *member, caller_control_action_t *action);  // undeaf   deaf off
///////////////////////////  2017-6-29   end    /////////////////////////////////
