...
void conference_video_launch_muxing_thread(conference_obj_t *conference, mcu_canvas_t *canvas, int super)
{
	...
	if (!canvas->video_muxing_thread) {
		...
		///////////////////////////////////////   2017-4-24   start  ///////////////////////////////
		// for debug  
		// \D5\E2\C0\EF\BD\F8ȥ\B5\C4\CF߳\CC\CA\C7 conference_video_muxing_thread_run
		switch_log_printf(SWITCH_CHANNEL_LOG, SWITCH_LOG_ERROR,
			"switch_thread_create 33333333333333333 \n");
		switch_log_printf(SWITCH_CHANNEL_LOG, SWITCH_LOG_DEBUG,"switch_thread_create\n");
